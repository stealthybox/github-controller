...
func main() {
	...
	flag.StringVar(&configfile, "config-file", "", "Config file for loading configurations.")
	...
	if configfile != "" {
		options, err = ctrl.NewOptionsFromComponentConfig(scheme, configfile, &ctrlv1alpha1.DefaultControllerConfiguration{})
		if err != nil {
